    ...
    <div className="pagina">
      ...
      <Secao id="claude">
        ...
        <div className="painel claude">
          {/* Adesivo, com o contorno branco e a sombra que vieram na arte: é
              a estética do mascote, e recortar o contorno tira justamente o
              que faz ele parecer colado na tela. Decorativa — quem usa leitor
              de tela já recebeu a marca no texto da pílula e no título. */}
          <img
